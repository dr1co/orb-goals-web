    ...
    <div className="flex items-center justify-center min-h-screen gap-80">
      ...
      <div className="w-full max-w-md p-8 space-y-6 bg-gray-900 rounded-lg shadow-lg">
        <div className="flex items-center justify-center gap-4">
          ...
          <h2 className="text-3xl font-bold text-violet-300">Login into Orb.goals!</h2>
        </div>
          ...
          <div>
            ...
            <div className="flex items-center mt-1">
              ...
              <Input
                ...
                className={`w-full ${validEmail ? "" : "border border-red-500"}`}
              />
            </div>
            <Label className={`text-red-500 mt-1 text-xs ${validEmail ? "hidden" : "flex"}`}>Please insert a valid e-mail!</Label>
          </div>
